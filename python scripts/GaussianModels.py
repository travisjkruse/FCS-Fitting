...
def gc_hermite(t,D,w1,w2,a1,a2,R1,R2,lambdaex1,lambdaem1,lambdaex2,lambdaem2,n,dz):
    return 0.5*quad(gcz1_hermite,-maxz,maxz,args=(t,D,w1,w2,a1,a2,R1,R2,lambdaex1,lambdaem1,lambdaex2,lambdaem2,n,dz))
    
def g0c(z,w1,w2,a1,a2,R1,R2,lambdaex1,lambdaem1,lambdaex2,lambdaem2,n,dz):
    return k(z+dz,a1,R1,lambdaem1,n)*k(z,a2,R2,lambdaem2,n)/np.sqrt(w2(z+dz,w1,lambdaex1,n))/np.sqrt(w2(z,w1,lambdaex1,n))

def vol2c(w1,w2,a1,a2,R1,R2,lambdaex1,lambdaem1,lambdaex2,lambdaem2,n,dz):
    return m.pi/4.0*quad(g0c,-maxz,maxz,args=(w1,w2,a1,a2,R1,R2,lambdaex1,lambdaem1,lambdaex2,lambdaem2,n,dz))[0]
