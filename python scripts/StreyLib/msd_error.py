...
chi=[]
red_chi=[]
a_range=np.linspace(0.4,0.7,11)
for a in a_range:
    ...
    chi.append(resultG2.chisqr)
    red_chi.append(resultG2.redchi)
...
#
#plt.figure()
#plt.plot(logtime,msdLog)
plt.figure()
plt.plot(a_range,chi,"o")
plt.figure()
plt.plot(a_range,red_chi,"o")
