...
time=np.logspace(-7,2,1000)
logtime=np.linspace(-7,2,1000)

msd=time*D
logmsd=np.log10(msd)

msdDNA=2.0*4.81*time+2.0/3.0*2.52*time**(2.0/3.0)
logmsdDNA=np.log10(msdDNA)

p=np.polyfit(logtime,logmsdDNA,20)
p2=np.polyder(p)
