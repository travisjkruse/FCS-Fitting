...
data3dGaussian=pd.read_csv(datadir+'gaussian'+postfix+'.csv')
data3dGaussianTriplet=pd.read_csv(datadir+'gaussian_triplet'+postfix+'.csv')
dataNumerical=pd.read_csv(datadir+'Numerical'+postfix+'.csv')
dataNumericalTriplet=pd.read_csv(datadir+'NumericalTriplet'+postfix+'.csv')
